...
description: C语言解法 100%/100%， 欢迎访问我的Githubhttps://github.com/tzzs/LeetCode-CN 。 1. 找到整数起始位置，即先去掉前面的空格，找到非空格有效字符，标志位置1，即整数计算开始 2. 开始进行数字的求和，从读取到的第一个数字开始求和，到下一位的时候即为
pubDate: '2020-04-03'
tags:
  - LeetCode CN
  - Online Judge
